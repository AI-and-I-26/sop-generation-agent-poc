...
# ---------------------------------------------------------------------------
# Alias expected by sop_workflow.py
# The workflow does: from src.agents.research_agent import run_research_node
# run_research_node is defined above — this comment confirms it is the export.
# Also expose research_tool as a direct alias for callers that use the old name.
# ---------------------------------------------------------------------------
