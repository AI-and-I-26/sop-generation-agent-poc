...
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
# Document Approval Table (Fix 5)
# Injected by formatter_agent immediately after the header on page 1.
# Ensures every generated SOP has a GxP-compliant approval signature block.
# ---------------------------------------------------------------------------
KB_APPROVAL_TABLE = """\
